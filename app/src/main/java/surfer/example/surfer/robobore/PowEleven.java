...
public class PowEleven extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pow_eleven);
        ...
        databaseReference =FirebaseDatabase.getInstance().getReference().child("statement11");
