...
public class PopTweleve extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pop_tweleve);
        ...
        databaseReference =FirebaseDatabase.getInstance().getReference().child("statement12");
