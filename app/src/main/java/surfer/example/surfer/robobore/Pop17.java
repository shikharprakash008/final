...
public class Pop17 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pop17);
        ...
        databaseReference =FirebaseDatabase.getInstance().getReference().child("statement17");
